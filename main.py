...
firebase=firebase.FirebaseApplication("https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/",None)
app = Flask(__name__)
...
def index1():
    ...
    data=firebase.get('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Products/'+email,'')
...
def submit():
    ...
    firebase.post('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Products/'+email, data)
    data=firebase.get('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Products/'+email,'')
...
def submit3():
    ...
    firebase.put('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Products/'+email+'/'+data_key, 'Quantity', str(int(l5[0])-int(selling_quantity)))
...
def submit4():
    ...
    list_index=0
    while True:
        firebase.put('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Products/'+email+'/'+data_key,keys[list_index],value[list_index])
...
def submit5():
    ...
    firebase.delete('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Products/'+email,data_key)
    data=firebase.get('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Products/'+email,'')
    if data==None:
        return render_template('index5.html')
    l2=[]
...
def submit6():
    ...
    if request.method == 'POST':
        if 'login' in request.form:
            ...
            data=firebase.get('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Users','')
            if data==None:
                ...
                for key,value in data.items():
                    ...
                    if value=={}:
                        for key1,value1 in value.items():
                            ...
                            #     return render_template('index6.html',message=message)
                            # else:
                                firebase.post('https://project-trial1-f40f0-default-rtdb.asia-southeast1.firebasedatabase.app/Users', input_data)
                                return render_template('index.html')
                    for key1,value1 in value.items():
                        if value1 == email:
                            message='incorrect password'
